...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::remote::remote_hosts_list,
            commands::remote::remote_host_pair,
            commands::remote::remote_host_forget,
            commands::remote::remote_host_rename,
            commands::remote::remote_host_reconnect,
            commands::remote::remote_host_project_snapshot,
            commands::remote::remote_host_invoke,
