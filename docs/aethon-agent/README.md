...
| File                | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `api.md`            | `globalThis.aethon` runtime API and the agent-visible A2UI tools: `setState`, `setLayout`, `patchLayout`, `canvas.*`, `registerComponent`, `registerSidebarSection`, `registerTheme`, `registerHighlightGrammar`, `onEvent`, plus the introspection helpers (`getFrontendState`, `listExtensions`, `listComponents`, `listThemes`, `getLayout`, `getRuntimeSnapshot`).                                                                                              |
