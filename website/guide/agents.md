...
For Codex, Aethon ships GPT-6 Astra plus GPT-5.6 Sol, Terra, and Luna under
ChatGPT auth with their 272,000-token context window. Astra, Sol, and Terra
offer Light through Ultra; Luna offers Light through Max. The selector
remains model-specific, so older Codex models keep their existing effort
vocabulary instead of inheriting options they do not support. Auto-compaction still reserves the configured pi
