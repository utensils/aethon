...
Last reviewed: 2026-04-27 (M5 phase 1 quick wins — button click unconditional, sidebar descendantId, handler-prompt notice, registerComponent shape, eventHandlers in snapshot, iteration-limit prompt warning).
